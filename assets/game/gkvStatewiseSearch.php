...
<div class="page-content">
    <div class="container">
       ...
       <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url(); ?>user/gkv/gkvStatewiseReport">Search for GKV</a>
                    <i class="fa fa-circle"></i>
                </li>
                 <li>
                    <span>GKV Data</span>
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            ...
                            <div style="float:right;margin-left:10px;">
                                <a class="dt-button buttons-pdf buttons-html5 btn default" href="<?php echo $base_url ?>user/gkv/gkvStatewiseReport"><span style="font-size:18px">BACK</span></a>
                            </div>
                        ...
                        <div class="portlet-body">
                            <div class="table-responsive">
                                <table width="100%" >
                                    ...
                                    <tr>
                                        <td align="center"><b>State&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<?php echo $stateName; ?></b></td>
                                ...
                                <table border="1">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="30px" rowspan="2">Region Name </th>
                                            <th width="60px" rowspan="2">Region Code </th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <th width="30px"><?php echo $details['region_name']; ?></th>
                                            <th width="60px"><?php echo $details['region_code']; ?></th>
